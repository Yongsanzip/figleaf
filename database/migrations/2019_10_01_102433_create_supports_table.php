...
class CreateSupportsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('supports', function (Blueprint $table) {
            ...
            $table->string('inicis_payMethod')->nullable()->comment('이니시스 결제수단코드');
            ...
            $table->tinyInteger('condition')->default(0)->comment('후원상태(0: 대기, 1:후원요청 , 2:후원결제완료 10:환불요청 11:부분환불 , 12:전체환불 13:환불 실, 98:결제실패 99: 결제취소)');
            $table->timestamps();
            $table->softDeletes();
        });
        //테이블 명세
