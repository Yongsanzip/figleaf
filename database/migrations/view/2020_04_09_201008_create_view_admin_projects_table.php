...
class CreateViewAdminProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Illuminate\Support\Facades\DB::statement('DROP VIEW IF EXISTS view_admin_projects');
        \Illuminate\Support\Facades\DB::statement("
                    CREATE VIEW view_admin_projects AS
                        SELECT pr.id                     AS `id`,
    ...
    {
        \Illuminate\Support\Facades\DB::statement('DROP VIEW view_admin_projects');
    }
}
