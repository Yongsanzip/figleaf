...
<form action="' + req.protocol + '://' + req.get('host') + '/password_reset" method="get">
    ...
    <div style="width:100%;max-width:800px;margin: auto;text-align: center;">
        <div style="padding:80px 0;">
            ...
            <a style="display: inline-block;background: #181818;color:white;vertical-align:middle;
                     ...
                     text-decoration: none;line-height: 30px;"href="{{route('password.reset'),['token'=>$user->verified_token,'email'=>$user->email]}}">비밀번호 재설정 페이지로 이동</a>
        </div>
